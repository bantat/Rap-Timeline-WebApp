...
class TestDataSource(TestCase):
    ...
    def verifyDatabaseAlbums(self):
        ...
        for album in albums:
            ...
            TestCase.assertTrue(len(album.getAlbumDescription()) > 0, error_description)
            TestCase.assertTrue(len(album.getAlbumImage()) > 0, error_image)
            TestCase.assertFalse('}' in album.getAlbumDescription(), error_description2)
            TestCase.assertFalse('{' in album.getAlbumDescription(), error_description2)
    ...
    def verifyDatabaseArtists(self):
        ...
        for artist in artists:
            ...
            TestCase.assertTrue(len(artist.getArtistDescription()) > 0, error_description)
            TestCase.assertTrue(len(artist.getArtistImage()) > 0, error_image)
            TestCase.assertFalse('}' in artist.getArtistDescription(), error_description2)
            TestCase.assertFalse('{' in artist.getArtistDescription(), error_description2)
