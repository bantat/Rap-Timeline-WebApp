...
def generateSqlFromAlbums(file_path):
    ...
    for album in albums:
        ...
        image = getImageNameFromUrl(getImageUrlFromWiki(name))
        year = album[1]
...
if __name__ == "__main__":
    ...
    print "Generating Artist Links"
    generateImageLinksFromArtists("artists.txt")
    print "Generating Album Links"
    generateImageLinksFromAlbums("albums.txt")